import { ItransactionParse } from "../types/reports";

export const transactionReport = async (
  email: string,
  transactions: ItransactionParse[]
) => {
  let transactionsString = "";
  console.log(transactions);
  transactions.forEach((transaction) => {
    const dateObject = new Date(transaction.date_of_transaction);
    ...
    transactionsString += `
   <tr>
      <td style="border: 1px solid #333; text-align: center; padding: 10px;">${formattedDate}</td>
      <td style="border: 1px solid #333; text-align: center; padding: 10px;">${formattedTime}</td>
      <td style="border: 1px solid #333; text-align: center; padding: 10px;">${transaction.amount}</td>
    </tr>`;
  });
  ...
  const html = `
                ...
                <td align="center" valign="top"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
                    <tr>
                      <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <tr>
                          <td align="center" valign="top"><a href="#" target="_blank" style="text-decoration:none;"><img src="https://res.cloudinary.com/dd6cbg23n/image/upload/v1702076887/R_slolqq.png" width="200" height="100px" alt="zywa" border="0" style="display:block; font-family:Arial, sans-serif; font-size:18px; line-height:25px; text-align:center; color:#1d4685; font-weight:bold; max-width:208px;" class="em_w150" /></a></td>
                        </tr>
                        <tr>
                ...
                <td align="center" valign="top" class="em_aside5"><table align="center" width="650" border="0" cellspacing="0" cellpadding="0" class="em_main_table" style="width:650px; table-layout:fixed;">
                    <tr>
                      <td align="center" valign="top" style="padding:0 25px; background-color:#ffffff;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <tr>
                          <td class="em_blue em_font_22" align="center" valign="left" style="font-family: Arial, sans-serif; font-size: 26px; line-height: 29px; color:#ffffff; font-weight:bold;">Transaction History</td>
                        </tr>
       ...
       <table style="border-collapse: collapse; width: 50%; margin: 20px auto;">
          <thead>
    <tr>
      <th style="border: 1px solid #333; text-align: center; padding: 10px; background-color: #87CEEB; color: #fff;">Email</th>
      <th style="border: 1px solid #333; text-align: center; padding: 10px; background-color: #87CEEB; color: #fff;">${email}</th>
    </tr>
  </thead>
  </tbody>
  ...
  <thead>
    <tr>
      <th style="border: 1px solid #333; text-align: center; padding: 10px; background-color: #87CEEB; color: #fff;">Transaction Date</th>
      <th style="border: 1px solid #333; text-align: center; padding: 10px; background-color: #87CEEB; color: #fff;">Time</th>
      <th style="border: 1px solid #333; text-align: center; padding: 10px;">Amount</th>
    </tr>
  </thead>
  <tbody>
 ${await transactionsString}
                      ...
                      <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <tr>
                          <td align="center" valign="top" style="font-size:0px; line-height:0px;"><table border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              <td width="15" align="left" valign="middle" style="font-size:0px; line-height:0px; width:15px;"><a href="zywa.com" style="text-decoration:none;"><img src="/assets/pilot/images/templates/email_img.png" width="15" height="12" alt="" border="0" style="display:block; max-width:15px;" /></a></td>
                              ...
                              <td class="em_grey em_font_11" align="left" valign="middle" style="font-family: Arial, sans-serif; font-size: 13px; line-height: 15px; color:#434343;"><a href="mailto:contact@zywa.com" style="text-decoration:none; color:#434343;">contact@zywa.com</a></td>
                            </tr>
                          </table>
                          </td>
                        </tr>
                         ...
                         <tr>
                          <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                              ...
                              <td class="em_grey em_font_11" align="left" valign="middle" style="font-family: Arial, sans-serif; font-size: 13px; line-height: 15px; color:#434343;"><a href="#" target="_blank" style="text-decoration:none; color:#434343;">zywa</a> &bull; &bull;  &bull;  &bull; UAE</td>
                            </tr>
                          </table>
                          </td>
                        </tr>
                      ...
                      <td align="center" valign="top" style="padding:0 25px;" class="em_aside10"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                        ...
                        <tr>
                          <td align="center" valign="top"><table border="0" cellspacing="0" cellpadding="0" align="left" class="em_wrapper">
                            <tr>
                              <td class="em_grey" align="center" valign="middle" style="font-family: Arial, sans-serif; font-size: 11px; line-height: 16px; color:#434343;">&copy; zywa</td>
                            </tr>
                          </table>
                          </td>
                        </tr>
